          ...
          <div className="hidden lg:block ms-auto">
            <ul className="navbar-nav flex gap-x-3 items-center justify-center">
              ...
              <li className="nav-item group relative">
                <a className="nav-link after:absolute hover:after:-bottom-10 after:inset-0">
                  Landing{" "}
                  <i className="fa-solid fa-angle-down ms-2 align-middle" />
                </a>
                <div className="absolute top-3 right-[-100px] mt-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible  translate-y-3 origin-center transition-all bg-white rounded-lg shadow-lg border p-2 w-96 grid grid-cols-2 gap-1.5">
              ...
              <li className="nav-item group relative">
                ...
                <div
                  ...
                  className="invisible absolute  top-3 left-[-50px] opacity-0 group-hover:visible group-hover:opacity-100 mt-4 group-hover:opacity-100 group-hover:translate-y-0 translate-y-3 origin-center transition-all bg-white rounded-lg shadow-lg border p-2 w-48 space-y-1.5"
                >
                  {/* Dropdown item */}
                  <div className="nav-item">
                    <a
                    ...
                    <div className="ms-2 hidden w-48 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 translate-y-3 origin-center transition-all bg-white rounded-lg shadow-lg border p-2 space-y-1.5">
                      <div className="nav-item">
